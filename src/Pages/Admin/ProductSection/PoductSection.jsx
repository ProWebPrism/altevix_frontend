...
const ProductSectionUpdate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiClient.put('/section/product-section', formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
      alert(response.data.message);
    } catch (error) {
      alert('Error updating the products section.');
    }
  };
...
export default ProductSectionUpdate;
